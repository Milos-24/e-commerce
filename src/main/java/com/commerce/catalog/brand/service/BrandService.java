package com.commerce.catalog.brand.service;

import com.commerce.catalog.brand.model.Brand;
import com.commerce.catalog.brand.repository.BrandRepository;
...
public class BrandService {
    ...
    public Optional<Brand> getBrandById(String id) { return brandRepository.findById(id); }
